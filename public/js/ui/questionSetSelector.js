...
export function initQuestionSetSelector(questionSetsApi, screenManager, lobbyManager, storage) {
    ...
    function selectQuestionSet(questionSet, cardElement) {
        ...
        if (createBtn) {
            ...
            createBtn.textContent = `Create Game: ${questionSet.name}`;
        }
    ...
    async function handleCreateGameWithQuestionSet() {
        if (!selectedQuestionSet) {
            showToast('Please select a question set first', 'warning');
            return;
        }
        ...
        try {
            ...
            if (createBtn && selectedQuestionSet) {
                createBtn.disabled = false;
                createBtn.textContent = `Create Game: ${selectedQuestionSet.name}`;
            }
        }
    }
    ...
    function clearSelection() {
        ...
        if (createBtn) {
            createBtn.disabled = true;
            createBtn.textContent = 'Create Game with Selected Set';
        }
    }
