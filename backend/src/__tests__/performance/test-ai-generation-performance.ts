...
test.describe('AI Generation and Vector Database Performance Tests', () => {
  ...
  test('AI question generation performance - single request', async ({ page }) => {
  ...
  test('AI question generation performance - multiple concurrent requests', async ({ page, context }) => {
  ...
  test('Vector database query performance', async ({ page }) => {
  ...
  test('Question set CRUD performance', async ({ page }) => {
    const startTime = performance.now();
  ...
  test('JSON import performance', async ({ page }) => {
  ...
  test('Memory usage during AI generation', async ({ page }) => {
