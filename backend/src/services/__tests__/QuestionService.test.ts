...
import { QuestionRepository, Question, QuestionSet, CreateQuestionData, CreateQuestionSetData, LocalizedText } from '../../repositories/QuestionRepository';
...
describe('QuestionService', () => {
  ...
  describe('Validation', () => {
    ...
    describe('validateQuestionData', () => {
      ...
      it('should reject question data without English text', () => {
        ...
        expect(result.errors).toContain('Question text must be provided in both English and German');
      });
      ...
      it('should reject question data with missing answer text', () => {
        const invalidData: CreateQuestionData = {
          ...
          answers: [
            {
              text: { en: 'Paris' } as LocalizedText,
              correct: true
            },
            {
              text: { en: 'London', de: 'London' },
        ...
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain('Answer 1 must have text in both English and German');
      });
    });
    ...
    describe('getLocalizedQuestion', () => {
        ...
        expect(result).toEqual(expected);
         ...
         const questionWithMissingGerman: Question = {
           ...
           answers: [
             ...
             {
               text: { en: 'London' } as LocalizedText,
               correct: false
             }
           ]
         };
      ...
      it('should generate correct answer IDs', () => {
        const questionWithManyAnswers: Question = {
          ...mockQuestion,
          answers: [
            { text: { en: 'A', de: 'A' }, correct: true },
            { text: { en: 'B', de: 'B' }, correct: false },
            { text: { en: 'C', de: 'C' }, correct: false },
            { text: { en: 'D', de: 'D' }, correct: false },
            { text: { en: 'E', de: 'E' }, correct: false },
            { text: { en: 'F', de: 'F' }, correct: false }
          ]
        };
  ...
  describe('Error Handling', () => {
    ...
    it('should handle validation errors', () => {
      const invalidData: CreateQuestionData = {
        question_set_id: 1,
        question_text: {} as LocalizedText,
        answers: []
      };
