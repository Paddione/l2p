...
import { LobbyRepository, Lobby, CreateLobbyData } from '../../repositories/LobbyRepository';
...
describe('LobbyService', () => {
  ...
  describe('Player Management', () => {
    ...
    describe('leaveLobby', () => {
      it('should remove player from lobby successfully', async () => {
        ...
        expect(result).toEqual(lobbyAfterLeave);
      });
      ...
      it('should delete lobby when host leaves', async () => {
        ...
        // Act
        const result = await lobbyService.leaveLobby('ABC123', 'player1');
    ...
    describe('updatePlayerReady', () => {
      it('should update player ready status successfully', async () => {
        ...
        // Act
        const result = await lobbyService.updatePlayerReady('ABC123', 'player1', true);
      ...
      it('should throw error when lobby not found', async () => {
        ...
        // Act & Assert
        await expect(lobbyService.updatePlayerReady('ABC123', 'player1', true))
          .rejects.toThrow('Lobby not found');
      });
    ...
    describe('updatePlayerConnection', () => {
      it('should update player connection status successfully', async () => {
        ...
        // Act
        const result = await lobbyService.updatePlayerConnection('ABC123', 'player1', false);
  ...
  describe('Lobby Cleanup', () => {
    describe('cleanupOldLobbies', () => {
      it('should cleanup old lobbies successfully', async () => {
        // Arrange
        const deletedCount = 5;
        mockLobbyRepository.cleanupOldLobbies.mockResolvedValue(deletedCount);
