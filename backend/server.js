...
function configureApp() {
    ...
    app.get('/api', (req, res) => {
        res.json({
            name: 'Quiz Meister API',
            version: '1.0.0',
            description: 'Backend API for Quiz Meister multiplayer quiz game',
            endpoints: {
                auth: {
...
async function startServer() {
    try {
        console.log('🚀 Starting Quiz Meister API server...');
        ...
        const server = app.listen(port, '0.0.0.0', () => {
            console.log(`🚀 Quiz Meister API server running on port ${port}`);
