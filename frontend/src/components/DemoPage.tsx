...
export const DemoPage: React.FC = () => {
  // Mock data for demo
  const mockPlayers = [
    { id: '1', username: 'Alice', character: 'wizard', isReady: true, isHost: true, score: 1250, multiplier: 3, correctAnswers: 5, isConnected: true },
    { id: '2', username: 'Bob', character: 'knight', isReady: true, isHost: false, score: 890, multiplier: 2, correctAnswers: 3, isConnected: true },
    { id: '3', username: 'Charlie', character: 'archer', isReady: false, isHost: false, score: 0, multiplier: 1, correctAnswers: 0, isConnected: true },
    { id: '4', username: 'Diana', character: 'mage', isReady: true, isHost: false, score: 2100, multiplier: 5, correctAnswers: 7, isConnected: false },
  ]
