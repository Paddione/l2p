...
test.describe('Comprehensive Accessibility Tests', () => {
  ...
  test('should pass comprehensive accessibility audit for all main pages', async ({ browser }) => {
    const context = configManager.createExecutionContext('test', 'accessibility');
  ...
  test('should meet color contrast requirements', async ({ page }) => {
    ...
    expect(contrastIssues.length).toBeLessThanOrEqual(Math.floor(textElements.length * 0.2)); // Max 20% can have issues
