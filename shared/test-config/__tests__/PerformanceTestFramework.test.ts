...
describe('PerformanceTestFramework', () => {
  ...
  test('should create Artillery configuration', () => {
    ...
    const mockContext = {
      ...
      test_type_config: {} as any,
      global_config: {} as any
    };

    const config = (performanceFramework as any).createArtilleryConfig(mockScenario, mockContext);
  ...
  test('should calculate average values correctly', () => {
    ...
    const average = (performanceFramework as any).calculateAverage(values);
  ...
  test('should calculate CPU usage correctly', () => {
    ...
    const cpuUsage = (performanceFramework as any).calculateCpuUsage(cpuMetrics);
  ...
  test('should handle empty metrics gracefully', () => {
    const emptyMetrics = (performanceFramework as any).getEmptyMetrics();
