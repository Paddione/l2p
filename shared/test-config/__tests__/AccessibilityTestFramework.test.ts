...
describe('AccessibilityTestFramework', () => {
  ...
  test('should get score class correctly', () => {
    const getScoreClass = (accessibilityFramework as any).getScoreClass;
  ...
  test('should sanitize URL correctly', () => {
    const sanitizeUrl = (accessibilityFramework as any).sanitizeUrl;
  ...
  test('should generate HTML report structure', () => {
    const mockResults = [
      {
        ...
        keyboardNavigation: [
          { test: { name: 'tab-test' } as any, passed: true, errors: [], screenshots: [] }
        ],
        colorContrast: [
          { selector: '.test', expectedRatio: 4.5, actualRatio: 5.0, passed: true, wcagLevel: 'AA' as const }
        ],
        ariaAttributes: [
    ...
    const htmlReport = (accessibilityFramework as any).generateHtmlReport(mockResults);
  ...
  test('should handle empty results gracefully', () => {
    ...
    const htmlReport = (accessibilityFramework as any).generateHtmlReport(emptyResults);
