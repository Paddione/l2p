...
exports.TestFileRegistryCLI = void 0;
const fs = __importStar(require("fs"));
const TestFileRegistry_1 = require("./TestFileRegistry");
class TestFileRegistryCLI {
    constructor(rootPath) {
        this.registry = new TestFileRegistry_1.TestFileRegistry(rootPath);
    }
    /**
...
exports.TestFileRegistryCLI = TestFileRegistryCLI;
